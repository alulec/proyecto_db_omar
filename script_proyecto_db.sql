...
grant update on credito.* to 'usuario2'@'localhost';
grant select on credito.* to 'usuario2'@'localhost';
grant delete on credito.* to 'usuario2'@'localhost';
ALTER USER 'operador1'@'localhost' FAILED_LOGIN_ATTEMPTS 3 PASSWORD_LOCK_TIME 3;